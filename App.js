...
import { StyleSheet, TextInput, Text, View, TouchableHighlight, FlatList, Image } from 'react-native';
        ...
        return (
            ...
            <View style={styles.scrollContainer}>
                <FlatList
                  ...
                  renderItem={({item}) => 
                    <TouchableHighlight onPress={() => { this.refs.sketchRef.loadSketch(this.state.pages[item.key].localFilePath); this.setState({text:item.text}) }}>
                        <Image style={styles.thumb} source={{isStatic:true, uri: item.localFilePath}}/>
                    </TouchableHighlight>
                  }
                  horizontal
                />
            ...
            <SketchView style={styles.sketchView} ref="sketchRef" 
